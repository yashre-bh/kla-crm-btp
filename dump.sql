...
INSERT INTO `checkpoints` VALUES (1,'cutting_area');
...
CREATE TABLE `employees` (
  ...
  CONSTRAINT `employees_ibfk_1` FOREIGN KEY (`checkpoint_id`) REFERENCES `checkpoints` (`checkpoint_id`)
...
INSERT INTO `employees` VALUES (1,'John Doe','5551234567',1),(2,'shreya','8303380096',1);
...
-- Dump completed on 2024-01-22 20:16:09
